...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & aksen utama menggunakan Oranye Terracotta (#C85A32) */
    ...
    /* Background info box disesuaikan dengan tone terracotta soft/warm (#FAF0EC) */
    '.info-box{background:#FAF0EC;border:1px solid #E8C8BC;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Oranye Terracotta (#C85A32) */
    ...
    '.syarat-box{background:#FCF8F5;border:1px solid #F0DDD5;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa soft terracotta/clay (#F7EBE6) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#F7EBE6;border:1px solid #E0B4A4;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#943717;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #E8C8BC;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
